...
const getTransporter = async () => {
    ...
    if (user && pass) {
        console.log(`Configuring SMTP using host: ${host}, user: ${user}`);
        ...
        try {
            ...
            <head>
                <style>
                    ...
                    .header { background: #1A4D2E; color: white; padding: 24px; text-align: center; }
                    ...
                    td { color: #495057; }
                    .priority-tag { display: inline-block; padding: 4px 10px; rounded: 4px; font-weight: bold; font-size: 12px; text-transform: uppercase; }
            ...
            <head>
                <style>
                    body { font-family: 'Segoe UI', Arial, sans-serif; color: #2D3436; margin: 0; padding: 20px; background-color: #F8F9FA; }
                    .container { max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05); border: 1px solid #E9ECEF; }
                    .header { background: #1A4D2E; color: white; padding: 30px 24px; text-align: center; }
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p style="font-size: 14px; line-height: 1.5; color: #495057;">
                            Our dedicated customer support and hygiene team will review the details and contact you via your preferred method (<strong>${contactMethod}</strong>) within 24 hours.
                        </p>
